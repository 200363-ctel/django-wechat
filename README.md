# 欢迎使用你的秒哒应用代码包
秒哒应用链接
    URL:https://www.miaoda.cn/projects/app-bhuklog9perl
...
pnpm run dev:weapp  # Start WeChat Mini-Program development server
```

## Build

```bash
pnpm run build      # Build for H5 production
pnpm run build:weapp # Build for WeChat Mini-Program production
```
